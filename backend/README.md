...
## Project Structure
    ...
    ├── testapiautostoryboa_95665  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_95665`
...
2. Clone this repo and `cd testapiautostoryboa_95665`
